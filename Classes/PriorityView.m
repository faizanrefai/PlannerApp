...
- (void)viewDidLoad {
    [super viewDidLoad];
	self.contentSizeForViewInPopover = CGSizeMake(100.0, 150.0);
	array=[[NSMutableArray alloc]initWithObjects:[UIImage imageNamed:@"Acitical.png"],[UIImage imageNamed:@"BHigh.png"],[UIImage imageNamed:@"C.png"],nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[[NSUserDefaults standardUserDefaults] setValue:strimage forKey:@"strimage_priority"];
	[[NSUserDefaults standardUserDefaults] synchronize];
    
	
	UIImage *image=[array objectAtIndex:indexPath.row];
	
	[planner CallMethodPriority:image];
}
