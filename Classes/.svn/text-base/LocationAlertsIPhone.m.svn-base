...
@implementation LocationAlertsIPhone
...
-(IBAction)addNewLocation:(id)sender{
    AddNewLocationIPhone *objAddNewLocation=[[AddNewLocationIPhone alloc]initWithNibName:@"AddNewLocationIPhone" bundle:nil];
