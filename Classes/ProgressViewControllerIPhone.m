...
-(void)dealloc{
    [super dealloc];
    if(array_cmplt!=nil){
        [array_cmplt removeAllObjects];
        [array_cmplt release];
        array_cmplt=nil;
    }
    if(array_progress!=nil){
        [array_progress removeAllObjects];
        [array_progress release];
        array_progress=nil;
    }
    if(array_sections!=nil){
        [array_sections removeAllObjects];
        [array_sections release];
        array_sections=nil;
    }
}
